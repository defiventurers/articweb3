...
export function ResultsScreen({ room, profile, onBackToLobby }) {
  ...
  async function claimPayout() {
    ...
    try {
      setBusy(true); setClaimError(""); setClaimStatus("Open AGW and confirm payout withdrawal.");
    ...
    } catch (err) { setClaimError(err.shortMessage || err.message || "Payout withdrawal failed."); } finally { setBusy(false); }
  }
