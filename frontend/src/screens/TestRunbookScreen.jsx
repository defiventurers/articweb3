...
import { BetaEnvCutoverPanel } from "../components/BetaEnvCutoverPanel.jsx";
...
import { BetaMainnetEnvAuditPanel } from "../components/BetaMainnetEnvAuditPanel.jsx";
import { BetaMainnetReadinessPanel } from "../components/BetaMainnetReadinessPanel.jsx";
import { BetaMainnetRehearsalPanel } from "../components/BetaMainnetRehearsalPanel.jsx";
...
import { BetaRollbackDrillPanel } from "../components/BetaRollbackDrillPanel.jsx";
  ...
  return (
    <section className="screen data-screen proof-screen">
      <div className="card data-card-shell proof-card">
        ...
        <BetaMainnetEnvAuditPanel />
        <BetaMainnetRehearsalPanel />
        <BetaEnvCutoverPanel />
        <BetaContractVerificationPanel />
        <BetaRollbackDrillPanel />
        <BetaBlockerTriagePanel />
        <BetaReleaseDecisionPanel />
        <BetaNextWavePlanPanel />
        <BetaEvidencePacketPanel />
        <BetaKpiPanel />
        <BetaIssueReviewPanel />
