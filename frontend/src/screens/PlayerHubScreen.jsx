  ...
  return (
    <section className="player-hub-page">
      <div className="player-hub-card">
        ...
        {SHOW_SETTLEMENT_ADMIN && <button className="player-hub-mode locked" onClick={onSettlementAdmin}><strong>Settlement Admin</strong><span>Set backend wallet as vault game server.</span></button>}
