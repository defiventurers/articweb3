...
const STORAGE_KEYS = [
  ...
  "artic.closedBeta.mainnetEnvAudit.v1",
  "artic.closedBeta.mainnetRehearsal.v1",
  "artic.closedBeta.envCutover.v1",
  "artic.closedBeta.contractVerification.v1",
  "artic.closedBeta.rollbackDrill.v1",
