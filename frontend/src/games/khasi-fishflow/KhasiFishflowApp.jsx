...
import { createKhasiHandicapDrillState } from "./drill.js";
import { KHASI_FISHFLOW_RULESET, actionSummary, applyAction, createKhasiFishflowState, describeTurn, getLegalActions, resultDetail, resultTitle } from "./rules.js";
...
export function KhasiFishflowApp({ onExitToLibrary, profile, onProfileChange }) {
  ...
  function start(nextMode) {
    setMode(nextMode);
    const next = nextMode === "drill" ? createKhasiHandicapDrillState() : createKhasiFishflowState({ mode: nextMode });
    setState(next);
